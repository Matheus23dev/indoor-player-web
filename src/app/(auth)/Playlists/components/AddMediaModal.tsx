      ...
      <div className="flex max-h-[95vh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
        <header className="flex items-center justify-between border-b px-6 py-4">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Escolha uma mídia da biblioteca.
            </p>
          </div>
                  ...
                  {visibleFolders.map(
                    (folder) => (
                      <button
                        ...
                        className="flex items-center gap-3 rounded-xl border border-gray-200 p-4 text-left hover:border-blue-400 hover:bg-blue-50"
                      >
                        <Folder
        ...
        <footer className="flex justify-end gap-3 border-t px-6 py-4">
          <button
            ...
            onClick={onClose}
            disabled={saving}
            className="rounded-xl border px-5 py-2.5 text-sm font-bold text-gray-700 hover:bg-gray-50 disabled:opacity-50"
          >
            Cancelar
          </button>
